...
static const int warp_cursor = 1;
...
/* screenshot*/
static const char *screenshotcmd[] = {"/home/ectslut/screenshotdwl.sh", NULL};
/* You can choose between:
...
static const Key keys[] = {
	...
	{ MODKEY, XKB_KEY_w, spawn, SHCMD("~/.local/bin/wallpaper-picker") },
	...
	/* Brightness */
	{ 0,       XF86XK_MonBrightnessUp,   spawn, SHCMD("brightnessctl s +2%")  },
	{ WLR_MODIFIER_SHIFT, XF86XK_MonBrightnessUp, spawn, SHCMD("brightnessctl s 100%") },
	{ 0,       XF86XK_MonBrightnessDown, spawn, SHCMD("brightnessctl s 2%-")  },
	{ WLR_MODIFIER_SHIFT, XF86XK_MonBrightnessDown, spawn, SHCMD("brightnessctl s 1%") },
	...
	{ WLR_MODIFIER_SHIFT, XF86XK_AudioMute,       spawn, SHCMD("wpctl set-mute @DEFAULT_SOURCE@ toggle")    },
